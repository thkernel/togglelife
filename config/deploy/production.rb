...
set :application, "togglelife"               # the name of your website - should also be the name of the directory
...
server "togglelife.com", user: "ubuntu", roles: %w{app db web}, ssh_options: {forward_agent: true}
